...
impl DynamicSession {
    ...
    pub fn verify_challenge_response(
        ...
        match self.client_ed25519_key.verify(message_to_verify.as_bytes(), &signature) {
            Ok(_) => {
...
impl AuthChallengeManager {
    ...
    pub fn create_response(&self, challenge_nonce: &str, challenge_timestamp: u64) -> Result<Vec<u8>> {
